...
const SECTIONS = [
  {
    ...
    body: "This app is a personal tool for downloading publicly available media for offline, personal use only. Downloading copyrighted content without the rights holder's permission may violate copyright law. Do not use this app to download and redistribute content you do not own.",
  },
  {
    icon: "ban-outline" as const,
    color: "#FF5252",
    title: "Platform Terms of Service",
    body: "Downloading content may violate the Terms of Service of the source platform (YouTube, Instagram, TikTok, etc.). Use this app responsibly and at your own risk. The developer is not liable for any misuse.",
  },
  {
    icon: "cloud-outline" as const,
    color: "#1AB7EA",
    title: "How It Works",
    body: "This app sends the URL you paste to a download API which finds the direct media link. No accounts, no logins, and no personal data is stored or transmitted.",
  },
  {
    icon: "lock-closed-outline" as const,
    color: "#4CAF50",
    title: "Privacy",
    body: "No personal data is collected or stored. The app does not track usage or share any information with third parties.",
  },
];
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.devCard}>
          <View style={s.devRow}>
            ...
            <View>
              ...
              <Text style={s.devName}>Umar J</Text>
            </View>
          </View>
        </View>
        ...
        <View style={s.disclaimer}>
          <Text style={s.disclaimerTxt}>
            This app is provided as-is for personal use. Content availability depends on external services outside the developer's control.
          </Text>
        </View>
